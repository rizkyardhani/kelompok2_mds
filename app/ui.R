...
fluidPage(
  ...
  dashboardHeader(
    title = div(
      img(src = "logo5.png", height = 50, width = 50),
    ...
    body = dashboardBody(
      tabItems(
        ...
        tabItem(
          tabName = "beranda",
          jumbotron(
            title = tags$h1("Halo, Selamat Datang di StatHub!",  style = "font-size:25px;color: #FFEA00;font-weight:bold;"),
        ...
        tabItem(
          ...
          tags$br(),
          box(
            title = "Yuk kenalan dengan kita!!",solidHeader = TRUE,status="primary", width = 12,
          tags$p("Situs ini merupakan projek praktikum kelompok mata kuliah Manajemen Data Statistika (STA1582) dari Program Studi Statistika dan Sains Data Pascasarjana IPB University."),  
          tags$h3("Kontributor :"),
          tags$ul(
            ...
            tags$li("Tukhfatur Rizmah A. sebagai Technical Writer"),style = "font-size:20px;"
          ),
